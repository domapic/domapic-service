...
const Connection = function (service, security) {
  ...
  const controllerClient = {
    users: {
      ...
      get: new ControllerClient('getUsers'), // TODO, filter or not
      create: new ControllerClient('createUser')
    },
    services: {
      get: new ControllerClient('getServices') // TODO, filter or not
    },
    abilities: {
      get: new ControllerClient('getAbilities'), // TODO, filter or not
      create: new ControllerClient('createAbility'),
      update: new ControllerClient('updateAbility'),
      remove: new ControllerClient('deleteAbility'),
