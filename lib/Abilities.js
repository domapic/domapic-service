...
const Abilities = function (service, connection) {
  ...
  const AbilityHandler = function (handler, auth) {
  ...
  const registerState = function (ability, name) {
    ...
    operations[operationId] = new AbilityHandler(ability.state.handler, ability.state.auth)
  ...
  const registerCommand = function (ability, name) {
    ...
    operations[operationId] = new AbilityHandler(ability.command.handler, ability.command.auth)
