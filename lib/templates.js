...
const templates = {
  ...
  abilityHasNothingToRegister: 'Ability "{{name}}" has no command, event nor state defined. Nothing to register',
  abilityHasNoData: 'Ability "{{name}}" has not mandatory "data" property defined',
  abilityTagDescription: 'Service ability named "{{name}}"',
  commandRequestBodyDescription: 'Data for the command "{{name}}"',
  commandResponseDescription: 'Current state of ability "{{name}}"',
  commandTagDescription: 'Service command',
  eventTagDescription: 'Service event',
  stateTagDescription: 'Service description',
