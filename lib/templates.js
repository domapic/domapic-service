...
const templates = {
  ...
  dataIsMandatory: 'No data was defined',
  dataIsNotAllowed: 'Data was provided to an ability without data defined',
  invalidAbilityData: 'Invalid data in {{type}} {{validationType}} "{{name}}": {{{message}}}',
  ...
  controllerClientnotConnected: 'Controller api interface not available. The service is not connected',
  ...
  errorRegisteringAbility: 'Error registering abilities: {{{message}}}'
}
